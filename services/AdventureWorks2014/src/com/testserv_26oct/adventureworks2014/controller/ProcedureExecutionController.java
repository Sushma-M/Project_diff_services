...
import com.testserv_26oct.adventureworks2014.service.AdventureWorks2014ProcedureExecutorService;
...
public class ProcedureExecutionController {
    ...
    @RequestMapping(value = "/procedure/execute/Procquery", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public List<Object> executeProcquery(@RequestParam(value = "deptid", required = false) java.lang.Integer deptid) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named procedure Procquery");
        List<Object> result = procedureService.executeProcquery(deptid);
