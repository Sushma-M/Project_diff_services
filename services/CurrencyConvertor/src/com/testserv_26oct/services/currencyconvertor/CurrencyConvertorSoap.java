...
public interface CurrencyConvertorSoap {
     ...
     */
    @WebResult(name = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", partName = "parameters")
    ...
    public ConversionRateResponse conversionRate(
        @WebParam(partName = "parameters", name = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/")
